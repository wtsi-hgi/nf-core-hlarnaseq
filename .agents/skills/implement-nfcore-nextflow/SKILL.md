...
4. Follow nf-core conventions:
   ...
   - assume runtime dependencies are available in the currently active Conda environment;
...
5. Update coordinated files when behavior changes:
   ...
   - tools: module metadata, active-Conda dependency assumptions, versions, `CITATIONS.md`;
