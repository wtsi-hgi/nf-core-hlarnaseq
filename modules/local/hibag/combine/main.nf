process HIBAG_COMBINE {
    ...
    // ("The shell-only consumers"). Pure shell, same rationale as
    // HLALA_COMBINE - which this module deliberately mirrors byte-for-byte in
    // its output contract, so it should mirror its environment too.
